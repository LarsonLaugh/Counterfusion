...
#====================================================================================================
# Define classes System and Edge
class System:
    ...
    def mastermat(self):
        """ Obtain the Landauer-Buettiker-like matrix equation """
        ...
        return mat
    def solve(self):
        """ Solve the Landauer-Buettiker-like matrix equation. """
    ...
    def plot(self,figsize=(12,10)):
        """ Visulize the evolution of states. """
        tnm = self.totalNumMover
        nfm = self.numForwardMover
        numTerminal = self.numTerminal
        blockStates = self.blockStates
    ...
    def _muj_finalstate(self, j, t, table):
        """ Recursively calculate the final state. """
